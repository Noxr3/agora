...
> = {
  connected:  { windowMs: 60_000, maxRequests: 600, perDay: 50_000, label: '600 req/min'  },
  verified:   { windowMs: 60_000, maxRequests: 30,  perDay: 5_000,  label: '30 req/min'  },
  unverified: { windowMs: 60_000, maxRequests: 5,   perDay: 100,    label: '5 req/min'   },
}
